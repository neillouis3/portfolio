      ...
      <div className="w-full h-full flex flex-row">
        <div className="flex-3 flex flex-col gap-8 w-full h-full">
          <div className="flex flex-col">
            ...
            <Chip size="md" radius="md" color="primary">Software Developer</Chip>
          </div>
          <div className="flex-3 flex-col flex gap-4">
            <p className="">Hi! I'm Louise and I'm a 3rd year computer engineering student @ Memorial University who is passionate about technology. I believe technology should be beneficial, enhancing quality of life and making everyday tasks easier.</p>
