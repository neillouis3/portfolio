...
export default function ProjectItem({title, description, imageLink, githubLink, demoLink, lang}) {
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            <div
                                class="flex py-0.5 px-1 bg-white w-fit rounded-full text-sm h-fit gap-1 "

                            >
                                <span
                                    class="h-4 w-4 rounded-full bg-blue my-auto"
                                ></span>In progress
                            </div>
                        </div>
                        <div
                            class="flex container gap-2 mt-1 "
                        >
                            <a
                                class=""
                                href={demoLink}
